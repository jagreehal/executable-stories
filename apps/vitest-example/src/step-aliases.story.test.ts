...
describe('Step Aliases', () => {
  it('AAA Pattern: Arrange-Act-Assert', ({ task }) => {
    story.init(task);
  ...
  it('Setup-Execute-Verify Pattern', ({ task }) => {
    story.init(task);
  ...
  it('Context-Action Pattern', ({ task }) => {
    story.init(task);
  ...
  it('User registration flow using aliases', ({ task }) => {
    story.init(task);
  ...
  it('All alias styles comparison', ({ task }) => {
    story.init(task);
