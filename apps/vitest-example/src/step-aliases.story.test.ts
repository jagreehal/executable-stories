/**
 * Comprehensive demonstration of ALL step function aliases in Vitest.
 *
...
story("Aliases support all modifiers", () => {
  doc.note("All aliases support .skip, .todo, .fails, and .concurrent modifiers");
...
// ============================================================================
// Concurrent Modifier with Aliases (Vitest-specific)
// ============================================================================

story("Aliases with concurrent modifier", () => {
  doc.note("The .concurrent modifier works with all aliases (Vitest only)");

  arrange("setup complete", () => {});

  arrange.concurrent("concurrent arrangement", async () => {
    await new Promise((resolve) => setTimeout(resolve, 5));
  });

  act.concurrent("concurrent action", async () => {
    await new Promise((resolve) => setTimeout(resolve, 5));
  });

  assert.concurrent("concurrent assertion", async () => {
    await new Promise((resolve) => setTimeout(resolve, 5));
    expect(true).toBe(true);
  });

  verify("all concurrent operations complete", () => {
    expect(true).toBe(true);
  });
});
...
// ============================================================================
// Callback Parameter Style (Vitest-specific)
// ============================================================================

story("Using callback parameter for aliases", (stepsApi: StepsApi) => {
  doc.note("Aliases are also available via the callback parameter");
  const { arrange: arr, act: ac, assert: asrt, setup: su, execute: ex, verify: ve, context: ctx, action: actn } = stepsApi;

  arr("arrange via callback", () => {});
  ac("act via callback", () => {});
  asrt("assert via callback", () => {
    expect(true).toBe(true);
  });

  su("setup via callback", () => {});
  ex("execute via callback", () => {});
  ve("verify via callback", () => {
    expect(true).toBe(true);
  });

  ctx("context via callback", () => {});
  actn("action via callback", () => {});
});
