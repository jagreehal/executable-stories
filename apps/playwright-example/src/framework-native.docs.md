...
## ✅ Calculator addition via framework-native test


## ✅ Calculator subtraction via framework-native test


## ✅ Comprehensive framework-native test
...
## ✅ Multiple calculator operations in one test
...
## ✅ Story with options
Tags: `playwright`, `options`
Tickets: `PW-001`

- **Given** setup with options
- **When** action with options
- **Then** assertion with options

## ✅ Using multiple Playwright fixtures

- **Given** all fixtures are available
- **When** browser info is captured
    **Browser:** chromium
- **Then** test completes with fixtures

## ✅ Using Playwright matchers in story steps
...
## ⏩ Using Playwright page fixture in stories

- **Given** page is available
- **When** page content is set
- **Then** page can be queried

## ✅ Using step prefix (singular)
...
### ✅ Basic multiplication sanity check
