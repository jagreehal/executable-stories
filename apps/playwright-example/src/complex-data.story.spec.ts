 ...
 * test() + story.init(testInfo) + story.note/json/table/code/mermaid/section (options objects).
 */
...
test('Deeply nested JSON structures', async ({}, testInfo) => {
  story.init(testInfo);
...
test('Arrays of complex objects', async ({}, testInfo) => {
  story.init(testInfo);
...
test('Large data tables', async ({}, testInfo) => {
  story.init(testInfo);
...
test('SQL code examples', async ({}, testInfo) => {
  story.init(testInfo);
...
test('YAML configuration examples', async ({}, testInfo) => {
  story.init(testInfo);
...
test('Shell script examples', async ({}, testInfo) => {
  story.init(testInfo);
...
test('Various Mermaid diagram types', async ({}, testInfo) => {
  story.init(testInfo);
...
test('Story with complex metadata structure', async ({}, testInfo) => {
  story.init(testInfo, {
...
test('All complex data types in one story', async ({}, testInfo) => {
  story.init(testInfo);
