...
Tags: `smoke`, `critical`, `feature:checkout` | Tickets: `PROJ-456`
...
Tags: `smoke`, `auth`, `login` | Tickets: `AUTH-001`
...
Tags: `regression`, `auth`, `login`, `negative` | Tickets: `AUTH-001`, `AUTH-015`
...
#### ✅ Payment processing
Tags: `critical`, `payment`, `checkout` | Tickets: `PAY-100`
