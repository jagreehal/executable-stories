...
- **Given** test results are loaded
- **Then** complex arrays are documented

## ✅ Capturing and documenting page data

- **Given** a page with structured content
- **When** data is extracted from page
...
- **Then** extracted data is documented
...
- **Given** browser feature matrix is needed
- **Then** large tables provide comprehensive reference

## ✅ Playwright test code examples

- **Given** Playwright code examples are documented
- **Then** TypeScript syntax is highlighted
...
- **Given** CI/CD configs are documented
