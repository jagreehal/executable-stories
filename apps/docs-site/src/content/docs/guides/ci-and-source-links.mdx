...
<ReportScreenshot
  src="/screenshots/feature-tickets.png"
  alt="Report showing ticket badges and source file links"
  caption="Ticket badges link to your issue tracker; source links go to the exact file on GitHub"
/>
