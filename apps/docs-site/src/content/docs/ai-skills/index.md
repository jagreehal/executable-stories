---
title: Agent skills
description: The 56 skills shipped with executable-stories, what each one covers, and how to install them into Claude Code, Cursor, or any agent that reads project files.
---
...
Install the few that match your stack rather than all 56:
