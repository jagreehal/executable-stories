 ...
 * Use it() + story.init() + story.given/when/then as markers; inline async/await between steps.
 */
...
it('Basic async/await in steps', async () => {
  story.init();
...
it('Parallel async operations with Promise.all', async () => {
  story.init();
...
it('Async setup and teardown pattern', async () => {
  story.init();
...
it('Error handling in async steps', async () => {
  story.init();
...
it('Working with timeouts and delays', async () => {
  story.init();
...
it('Async iteration over collections', async () => {
  story.init();
...
it('Parallel iteration with Promise.all and map', async () => {
  story.init();
...
it('Real-world async API test pattern', async () => {
  story.init();
...
it('Async steps with runtime documentation', async () => {
  story.init();
