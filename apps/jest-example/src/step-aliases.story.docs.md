...
## ✅ Using steps parameter for aliases

- **Given** arrange via steps
- **When** act via steps
- **Then** assert via steps
- **And** setup via steps
- **And** execute via steps
- **And** verify via steps
- **And** context via steps
- **And** action via steps
