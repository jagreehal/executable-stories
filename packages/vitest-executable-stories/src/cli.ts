...
if (!command || command === "help" || command === "--help" || command === "-h") {
  console.log("vitest-executable-stories collate --glob \"**/*.json\" --out docs/story-index.json");
  console.log("vitest-executable-stories collate --format md --glob \"**/*.md\" --out docs/story-index.json");
  process.exit(0);
}
