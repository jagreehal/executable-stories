...
/** Parse CLI args for the collate command. */
...
/** Collate JSON reports into a single index file. */
...
/** Collate Markdown reports with front-matter into a single index file. */
...
/** Minimal YAML parser for front-matter (no arrays, no anchors). */
...
/** Parse basic YAML scalar values. */
...
/** Apply a JSON config file to options. */
...
/** Normalize format values to supported options. */
...
if (!command || command === "help" || command === "--help" || command === "-h") {
  console.log("playwright-executable-stories collate --glob \"**/*.json\" --out docs/story-index.json");
  console.log("playwright-executable-stories collate --format md --glob \"**/*.md\" --out docs/story-index.json");
  process.exit(0);
}
