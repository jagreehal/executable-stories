...
import { failedScenario } from '../storybook/fixtures';
...
export const OneFailure: StoryObj = {
  render: () => renderFailureSummary({ failedCases: [failedScenario()] }, deps),
};
...
export const Empty: StoryObj = {
  render: () => {
    ...
    return (
      html ||
      '<p style="color:var(--muted-foreground)">No failures — nothing rendered.</p>'
    );
  },
};
