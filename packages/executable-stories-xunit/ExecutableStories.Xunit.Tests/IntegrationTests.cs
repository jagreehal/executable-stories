...
namespace ExecutableStories.Xunit.Tests
{
    ...
    public class IntegrationTests : IDisposable
    {
        ...
        [Fact]
        public void EndToEndStoryApiProducesValidStoryMeta()
        {
            ...
            // Step-level docs
            _ = Assert.Single(ctx.Steps[0].Docs!); // Given has kv
            _ = Assert.Single(ctx.Steps[1].Docs!); // When has json
            _ = Assert.Single(ctx.Steps[2].Docs!); // Then has link
        }

        [Fact]
        public void EndToEndStoryMetaSerializesToJson()
        {
        ...
        [Fact]
        public void EndToEndRawRunSerializesToJson()
        {
            ...
            var json = JsonSerializer.Serialize(rawRun, s_jsonOptions);
        ...
        [Fact]
        public void EndToEndRawRunWriterCreatesFile()
        {
        ...
        [Fact]
        public void EndToEndDocEntriesSerializeCorrectly()
        {
