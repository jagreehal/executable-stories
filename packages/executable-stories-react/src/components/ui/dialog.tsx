...
// Base UI's overlay is `Backdrop` (Radix `Overlay`), animated via
// data-[starting-style] / data-[ending-style] (Radix data-[state=open/closed]).
...
// Base UI's content is `Popup` (Radix `Content`).
