...
function SelectContent({
  className,
  children,
  // Base UI aligns items with the trigger by default (Radix "item-aligned");
  // pass position="popper" for trigger-anchored placement.
...
// Base UI's Select has no Separator part; render a plain decorative divider.
